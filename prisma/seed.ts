...
async function createManyConsults(clinicReference: User) {
  ...
  let startsAt = "2023-05-03 15:00";
  let endsAt = "2023-05-03 15:40";
  ...
  startsAt = "2023-05-03 09:40";
  endsAt = "2023-05-03 10:00";
  ...
  startsAt = "2023-05-03 08:00";
  endsAt = "2023-05-03 08:30";
  status = ConsultStatus.RETORNO;
  await createConsult(
    NUTRICIONISTA_04,
    patient_04,
  ...
  startsAt = "2023-05-03 12:00";
  endsAt = "2023-05-03 12:30";
  status = ConsultStatus.RETORNO;
  await createConsult(
    NUTRICIONISTA_04,
    patient_14,
  ...
  startsAt = "2023-05-03 08:30";
  endsAt = "2023-05-03 09:00";
  status = ConsultStatus.REALIZADO;
  await createConsult(
    PSIQUIATRA_06,
    patient_06,
  ...
  startsAt = "2023-05-03 14:30";
  endsAt = "2023-05-03 15:00";
  status = ConsultStatus.CANCELADO;
  await createConsult(
    PSIQUIATRA_06,
    patient_07,
